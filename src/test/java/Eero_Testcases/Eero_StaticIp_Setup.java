...
public class Eero_StaticIp_Setup {
	
public AndroidDriver driver;
	
	public Eero_StaticIp_Setup(AndroidDriver driver) {
		
		this.driver = driver;
	}
	
public void eero_Static_GatewaySetup() throws InterruptedException {
	...
	//Menu section
		...
		//Selecting Static IP option
		driver.findElement(AppiumBy.id("com.eero.android.dogfood:id/static_ip_radio_row")).click();
		//Entering credentials
		driver.findElement(AppiumBy.xpath("//android.view.ViewGroup[@resource-id='com.eero.android.dogfood:id/static_ip_address_input']/child::*/child::*")).sendKeys("192.168.1.124");
		driver.findElement(AppiumBy.xpath("//android.view.ViewGroup[@resource-id='com.eero.android.dogfood:id/static_subnet_mask_input']/child::*/child::*")).sendKeys("255.255.252.0");
		driver.findElement(AppiumBy.xpath("//android.view.ViewGroup[@resource-id='com.eero.android.dogfood:id/static_router_ip_input']/child::*/child::*")).sendKeys("192.168.1.1");
		//Apply button
		...
		//Selecting the router location
				...
				if(onlineStatus.equals("Online")) {
					System.out.println("Static network has been created successfully");
				}else {
					System.out.println("Static network has not been established");
				}
}

public void eero_StaticIp_Leafnode() throws InterruptedException {
	driver.findElement(AppiumBy.accessibilityId("Home")).click();
...
public void eero_BadStaticIp_Setup() throws InterruptedException {
	//Menu section
			driver.findElement(AppiumBy.accessibilityId("Open the add menu")).click();
			//Network is offline 
			driver.findElement(AppiumBy.id("android:id/button1")).click();
